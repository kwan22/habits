...
<details>
  ...
  <img src="./images/lv2/1a_crossing6_wave.webp" width="480"/>
  <img src="./images/lv2/2a_start_under.webp" width="480"/>
  <img src="./images/lv2/3a_start_wave.webp" width="480"/>
  <img src="./images/lv2/4a_shrine_block_wave.webp" width="480"/>
  <img src="./images/lv2/5a_start_bubbleskip.webp" width="480"/>
  <img src="./images/lv2/6a_lake_kevin_reroute.webp" width="480"/>
</details>
...
<details>
  ...
  <img src="./images/lv2/7a_500m_wb.webp" width="480"/>
  <img src="./images/lv2/7a_500m_wb2.webp" width="480"/>
  <img src="./images/lv2/7a_2000m_berry1.webp" width="480"/>
  <img src="./images/lv2/7a_flag2_wb3.webp" width="480"/>
</details>
...
<details>
  ...
  Without having fully learned extension timing and only following the advice of wavedash.ppt, supers have limited use. As extension timing will become an integral part at higher levels of gameplay, we will instead use Search skip to provide visual guidance on learning extension timing. <br>
    <img src="./images/lv2/5a_search_skip_slow.webp" width="480"/> <br>
  ...
  <img src="./images/lv2/5a_search_skip_early.webp" width="480"/>
  <img src="./images/lv2/5a_search_skip_early.png" width="480"/> <br>
...
<details>
  ...
  <img src="./images/lv2/5a_rescue_theosuper.webp" width="480"/>
  <img src="./images/lv2/5a_rescue_theohyper.webp" width="480"/> <br>
Be cognizant of when you have leeway to throw and hyper, whether it be seekers or even in the eyeball room. Reckless movement in eyeball room will not do you any favors even if you don't die. <br>
  <img src="./images/lv2/5a_rescue_eyeball.webp" width="480"/> <br>
...
<details>
  ...
  <img src="./images/lv2/7a_2500m_wave.webp" width="480"/>

  While the notion of active movement is still in its early stages, we still must be ready for the red-dot at all times.
  <img src="./images/lv2/3a_suite_final_cut.webp" width="480"/>
</details>

## 2 jump binds  
This means having dash (or demo), 2 jump binds, and grab on keys that can (ideally) all be pressed and released independently of each other. At minimum, the two jump binds should be independent, and one of the jump binds should be on a different finger than dash so the two (jump1+jump2 or jump+dash) can be pressed in a very quick sequence. 

Bind a menu down-confirm bind for retry and skip cutscene. Ideally, pause, menu-down+confirm, and confirm should also be on independent fingers, but menu binds are less important than the movement binds. 
...
<details>
  ...
  <img src="./images/lv2/2j_1a.webp" width="480"/> 
  <img src="./images/lv2/2j_3a_1.webp" width="480"/> 
  <img src="./images/lv2/2j_3a_2.webp" width="480"/> 
  <img src="./images/lv2/2j_4a.webp" width="480"/> <br>
...
[Some example bind layouts](https://docs.google.com/spreadsheets/d/196LjGk2m0i4ZUtzOpTVLT-BRb6p8dcS052eAxJV96uA/edit?gid=985448244#gid=985448244) from various high-level players are collected here. For now, just focus on having both jumps on independent fingers, and dash on a different finger than one of your jumps. For controller players, I recommend having a jump as one of the shoulder buttons, as having both jumps on face buttons can be non-ideal ergonomically.
