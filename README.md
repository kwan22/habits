...
This document is accompanied by a [video series](https://www.youtube.com/watch?v=wn3RARvFiFE&list=PLPTo7ZG8_ivLBmpa0oxqO4F7zII4MTxqe) where I perform speedruns while following these rules. These mainly serve as demonstration of me following the rulesets and showcase how I approach performing runs, partially for entertainment but also to be instructive. Habits is not necessarily meant to be a prescription for strats for a given skill level, but I did try to select strats at each level to reasonably reflect a comparable level of execution. 
