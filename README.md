...
Non-basic setups would include strats with pixel lineups or subpixel manip (climbing lineups for 3a demo), unintuitive setups with invisible details (4a cpop, 6a lakeskip), long pause-buffer setups requiring memorizing specifc pixels or frames, 2fs in general, etc. 
